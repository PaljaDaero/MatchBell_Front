...
public abstract class Hilt_ProfileSetupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfileSetupFragment() {
    super();
  }

  Hilt_ProfileSetupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfileSetupFragment_GeneratedInjector) this.generatedComponent()).injectProfileSetupFragment(UnsafeCasts.<ProfileSetupFragment>unsafeCast(this));
    }
  }
