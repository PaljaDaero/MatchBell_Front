...
public abstract class Hilt_SignupInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignupInfoFragment() {
    super();
  }

  Hilt_SignupInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignupInfoFragment_GeneratedInjector) this.generatedComponent()).injectSignupInfoFragment(UnsafeCasts.<SignupInfoFragment>unsafeCast(this));
    }
  }
