...
public abstract class Hilt_SignupTermsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignupTermsFragment() {
    super();
  }

  Hilt_SignupTermsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignupTermsFragment_GeneratedInjector) this.generatedComponent()).injectSignupTermsFragment(UnsafeCasts.<SignupTermsFragment>unsafeCast(this));
    }
  }
